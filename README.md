...
- The `ecommerce-client` folder contains the frontend code.
- The frontend application is built using `React`, `Typescript` and `Tailwindcss`.

### Kubernetes

- The `ecommerce-k8s` folder contains the objects code needed to deploy the microservices to kubernetes.
